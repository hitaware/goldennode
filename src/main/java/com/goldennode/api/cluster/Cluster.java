...
public abstract class Cluster {
	...
	protected abstract int newCondition(ClusteredObject co) throws ClusterException;

	protected abstract void await(int conditionId) throws ClusterException;

	protected abstract void signal(int conditionId) throws ClusterException;

	protected abstract void signalAll(int conditionId) throws ClusterException;
