...
public class MethodUtilsTest {
	...
	public void test() throws Exception {
		...
		Assert.assertEquals("5", ReflectionUtils.callMethod(rt, "method2",
				new Object[] { new Integer(1) }));
		Assert.assertEquals("6", ReflectionUtils.callMethod(rt, "method3",
				new Object[] { new Integer(1) }));
		...
		Assert.assertEquals(true, ReflectionUtils.callMethod(rt, "method6",
				new Object[] { null }));
