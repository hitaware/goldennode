...
import com.goldennode.api.core.GoldenNodeServerTest;
...
public class MultiResponseTest {
	...
	public void testIsSuccessfulCall() {
		...
		Assert.assertEquals(false, mrNoResponse.isSuccessfulCall("control_text"));
	}
	...
	public void testGetResponseFromSingleServer() throws ClusterException, ServerException {
		Assert.assertEquals("control_text", mrSuccessful.getResponseFromSingleServer(getGoldenNodeServer("1"))
				.getReturnValue());
		Assert.assertEquals("control_text", mrErrorneous.getResponseFromSingleServer(getGoldenNodeServer("1"))
				.getReturnValue());
	}
